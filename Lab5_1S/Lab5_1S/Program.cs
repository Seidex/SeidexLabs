...
namespace Lab5_1S
{
    ...
    class Program
    {
        ...
        public static int MaxCountOfDownload(List<Visiting> lst)
        {
            Console.Clear();
            int IndexMax = 0;
        ...
        public static void AvarageHosts(List<Visiting> lst)
        {
            Console.Clear();
            float av = 0;
            foreach (Visiting gs in lst)
        ...
        public static void AvaregeUpper(List<Visiting> lst)
        {
            Console.Clear();
        ...
        public static void AddNew(List<Visiting> Date)
        {
        ...
        public static void ShowTable(List<Visiting> Visiting)
        {
            int MaxI = 15;
            int MaxN = 12;
            int MaxW = 19;
